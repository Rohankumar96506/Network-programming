...
/* BUFFER_SIZE is the size of message send to server
   NAME_BUFFER_SIZE is the size of name
   HOST_ADDR is the port number from where out application will listen
...
//to handle recieve call from server and print on terminal
...
//to add end of line in place of new line
